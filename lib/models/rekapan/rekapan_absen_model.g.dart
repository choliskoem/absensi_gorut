...
RekapanAbsenModel _$RekapanAbsenModelFromJson(Map<String, dynamic> json) => RekapanAbsenModel(
  status: json['status'] as int,
  body: json['body'] == null
      ? null
      : DataRekapanAbsenModel.fromJson(json['body'] as Map<String, dynamic>),
);

DataRekapanAbsenModel _$DataRekapanAbsenModelFromJson(Map<String, dynamic> json) =>
...
Child _$ChildFromJson(Map<String, dynamic> json) {
  return Child(
      ...
      ? null
      : DataAbsenKeluar.fromJson(json['absenKeluar'] as Map<String, dynamic>),
